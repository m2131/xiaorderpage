    ...
    <section style="background: #fff;padding: 20px;">
        <el-row>
            ...
            <el-col style="margin-bottom: 10px">
                <el-button size="mini" type="danger" @click="wcOpen()">新增商品</el-button>
                <el-button size="mini" type="danger" @click="wcOpens()">批量导入商品</el-button>
            </el-col>
            <el-col>
    ...
    export default {
        ...
        methods: {
            wbQuery(){
                ...
                api.post('/merchant/UserGood')(postData).then((result) => {
